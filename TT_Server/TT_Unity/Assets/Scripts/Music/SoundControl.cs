...
public class SoundControl : MonoBehaviour
{
    ...
    void Start ()
    {
        ...
        _currentMusicSection = MusicSection[_currentSection];
    }
    ...
    public int nextSection()
    {
        ...
        if (isIntro)
        {
            ...
            _currentSection = 1;
            _previousSection = 0;
            return MusicSection[0].Play();
        } else
        {
            MusicSection[_previousSection].StopAll();
            //TODO:: distasteful code, but ok...
        ...
        return MusicSection[_currentSection].Play();
    }
